...
% with a given disciminability value d . Determine this value by trial and error, i.e. taking different values d and drawing the corresponding ROC curves until you find a value of d for which the corresponding ROC curve passes through the experimentally determined point.
